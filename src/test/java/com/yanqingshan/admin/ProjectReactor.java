 ...
 *
 * @author yanqs
 * @date 2023年04月21日 18:15
 */
@Slf4j
public class ProjectReactor {
    private static final String GROUP_ID = "com.yanqingshan";
    private static final String ARTIFACT_ID = "springboot-startup";
    private static final String PACKAGE_NAME = "com.yanqingshan.admin";
    private static final String TITLE = "SpringBoot单体程序脚手架";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.yanqingshan";
        String artifactIdNew = "springboot-startup";
        String packageNameNew = "com.yanqingshan.admin";
        String titleNew = "SpringBoot单体程序脚手架";
